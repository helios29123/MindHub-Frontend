import { Course, User, Notification, Order, FlaggedItem, PayoutRequest, AuditLog, Banner } from '@/shared/types';
...
export const INITIAL_COURSES: Course[] = [
  ...
  {
    id: 'mock-course-1',
    title: 'Khóa học Đã Xuất Bản (Mock)',
    subtitle: 'Khóa học mẫu trạng thái active',
    description: 'Đây là khóa học mẫu được tạo ra cho mục đích demo trạng thái active.',
    category: 'Development',
    subcategory: 'Web Development',
    instructorId: 'u-02',
    instructorName: 'Instructor Test',
    instructorTitle: 'Chuyên gia AI',
    instructorAvatar: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=150',
    instructorBio: 'Giảng viên demo',
    price: 500000,
    rating: 4.5,
    reviewCount: 12,
    enrolledCount: 45,
  ...
  {
    id: 'mock-course-2',
    title: 'Khóa học Đang Nháp (Mock)',
    subtitle: 'Khóa học mẫu trạng thái draft',
    description: 'Đây là khóa học mẫu được tạo ra cho mục đích demo trạng thái draft.',
    category: 'Development',
  ...
  {
    id: 'mock-course-3',
    title: 'Khóa học Đang Chờ Duyệt (Mock)',
    subtitle: 'Khóa học mẫu trạng thái pending',
    description: 'Đây là khóa học mẫu được tạo ra cho mục đích demo trạng thái pending_review.',
    category: 'Development',
    subcategory: 'Machine Learning',
    instructorId: 'u-02',
    instructorName: 'Instructor Test',
  ...
  {
    id: 'mock-course-4',
    title: 'Khóa học Bị Từ Chối (Mock)',
    subtitle: 'Khóa học mẫu trạng thái rejected',
    description: 'Đây là khóa học mẫu được tạo ra cho mục đích demo trạng thái rejected.',
    category: 'Development',
    subcategory: 'Python',
    instructorId: 'u-02',
    instructorName: 'Instructor Test',
    ...
    willLearn: [],
    status: 'rejected',
    rejectionReason: 'Nội dung khóa học chưa đầy đủ, thiếu video bài giảng chương 1 và thumbnail chất lượng quá thấp. Vui lòng cập nhật lại theo đúng tiêu chuẩn MindHub.',
    chapters: [],
    reviews: [],
    faqs: [],
