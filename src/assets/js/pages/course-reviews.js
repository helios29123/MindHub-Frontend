...
function bindEvents() {
  ...
  if (form) {
    console.log("[CourseReviews] form found, attaching submit listener");
    form.addEventListener("submit", (e) => {
      e.preventDefault();
      console.log("[CourseReviews] form submitted");
      ...
      if (pageState.date_preset === "custom") {
        ...
        if (!validateCustomDateRange()) {
          console.log("[CourseReviews] date validation failed");
          return;
        }
      }
      ...
      pageState.page = 1;
      writeStateToUrl();
      console.log("[CourseReviews] calling fetchAndRender", pageState);
      fetchAndRender(true);
    });
  } else {
    console.error("[CourseReviews] form NOT found!");
  }
