...
Hãy viết một hàm đệ quy để giải quyết bài toán lồng thư mục và tối ưu hóa thời gian chạy O(n).`;
      ...
      if (idx === chapterIdx) {
        return {
          ...
          lessons: ch.lessons.map(les => {
            if (les.id === lessonId) {
              const currentQuiz = les.quiz || { id: 'qz-' + Date.now(), title: 'Bài tập trắc nghiệm khái niệm', questions: [] };
              return {
                ...les,
                quiz: {
                  ...currentQuiz,
  ...
  const startBuilderForEdit = (course: Course) => {
    ...
    setAllowDiscussion(course.allowDiscussion !== false ? course.allowDiscussion : true);
                                  ...
                                  <div className="flex items-center gap-2">
                                    <button
                                      ...
                                      onClick={() => {
                                        ...
                                        setNewLessonType(les.type || 'video');
