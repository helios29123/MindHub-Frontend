import { INITIAL_COURSES, INITIAL_USER, SYSTEM_ROLE_USERS, INITIAL_NOTIFICATIONS, INITIAL_FAVORITES, FLAGGED_REVIEWS_MOCK, PAYOUT_REQUESTS_MOCK, INITIAL_BANNERS } from '@/shared/data';
import { Course, User, Order, Notification, AccountRequest, PayoutRequest, FlaggedItem } from '@/shared/types';
